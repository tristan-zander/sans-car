...
namespace Data
{
    public static class ProjectConfiguration
    {
         public static FullConfiguration ReadConfigFile(string configPath = "")
        {
            ...
            var deserializedConfig = JsonSerializer.Deserialize<FullConfiguration>(file, new JsonSerializerOptions{ IncludeFields = true});

            if (deserializedConfig == null)
            {
                throw new Exception("There was an error in your config file and it could not be properly deserialized.");
            }
    ...
    public sealed class FullConfiguration
    {
        ...
        public LavalinkConfiguration Lavalink { get; set; }
